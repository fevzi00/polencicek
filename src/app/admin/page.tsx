  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 border border-slate-200">
       ...
       <Link href="/admin/products/new">
  <button className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl hover:shadow-xl hover:scale-105 transition-all font-semibold flex items-center gap-2 whitespace-nowrap">
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        {filteredProducts.length === 0 ? (
          <div className="text-center py-12">
            ...
            {!searchQuery && (
              <Link href="/admin/products/new">
                <button className="btn-primary px-8 py-3">İlk Ürünü Ekle</button>
              </Link>
            )}
          </div>
        ) : (
